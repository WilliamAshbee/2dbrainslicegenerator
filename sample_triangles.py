...
surface = Surface.read_triangular('/data/hcp-plis/hdd05/101410/T1w/101410/surf/lh.white')
...
pointsTest = np.array([10,20,-5])
#plane_test = np.array([0,1,0])
#d_test = plane_test*10
from skspatial.objects import Plane
pl = Plane.from_points([1,10,0],[0,10,1],[1,10,1])
#ptpRes = pointsToPlane(pointsTest,plane_test,d_test)
ptpRes = pl.project_point(pointsTest)
...
#create synthetic data as a form of reinforcement learning